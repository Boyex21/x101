    ...
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
      ...
      <div className="space-y-5">
        ...
        <div className="border-2 border-primary rounded-2xl p-6 bg-primary/5 relative">
          ...
          <p className="text-2xl font-black text-primary mb-4">$89<span className="text-sm font-medium text-muted-foreground">/año</span></p>
        ...
        <div className="border-2 border-dashed border-muted-foreground/30 rounded-2xl p-6 bg-muted/30 relative opacity-80">
          ...
          <div className="flex items-center justify-between mt-2 mb-4">
            ...
            <span className="text-xl font-black text-accent">+$40<span className="text-xs font-medium text-muted-foreground">/año</span></span>
          </div>
          <div className="space-y-3">
            {[
        ...
        <div className="border-2 border-dashed border-muted-foreground/30 rounded-2xl p-6 bg-muted/30 relative opacity-80">
          ...
          <div className="flex items-center justify-between mt-2 mb-4">
            ...
            <span className="text-xl font-black text-secondary">+$60<span className="text-xs font-medium text-muted-foreground">/año</span></span>
          </div>
          <div className="space-y-3">
            {[
